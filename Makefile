...
-m 128M \
-netdev user,id=mynet0,hostfwd=udp::5555-:22 -device virtio-net-pci,netdev=mynet0,mac=de:ad:be:ef:dd:dd,id=virtio-dev -object filter-dump,id=f1,netdev=mynet0,file=$(BUILD_DIR)/net_dump.dat # Dump network traffic
